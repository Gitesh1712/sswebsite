...
function toggleSkills() {
  let parent = this.parentNode; // Get the parent .skills__content
  let isClosed = parent.classList.contains("skills__close");

  // Close all sections first
  skillsContent.forEach((section) => {
    section.classList.remove("skills__open");
    section.classList.add("skills__close");

    // Reset arrow icon
    const arrow = section.querySelector(".uil");
  ...
  if (isClosed) {
    ...
    // Rotate arrow icon
    const arrow = parent.querySelector(".uil");
